<xsl:stylesheet
    ...
    <xsl:template match="@*|*">
      ...
      <xsl:key name="search-exe" match="wix:Component['CAService.exe' = substring(wix:File/@Source, string-length(wix:File/@Source) - string-length('CAService.exe') + 1)]" use="@Id"/>
